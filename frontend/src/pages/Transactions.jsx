          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
              ...
              <select 
                ...
                className={`px-4 py-2.5 rounded-xl border text-xs font-bold uppercase tracking-wider outline-none ${isDark ? 'bg-slate-900 border-slate-800 text-slate-400' : 'bg-slate-50 border-slate-200 text-slate-600'}`}
              >
              ...
              <button 
                ...
                className={`p-2.5 rounded-xl border transition-all ${isDark ? 'bg-slate-900 border-slate-800 text-slate-400 hover:bg-slate-800' : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-white'}`}
              >
                <ArrowLeftRight className={`w-4 h-4 transition-transform ${sortOrder === 'desc' ? 'rotate-180' : ''}`} />
              </button>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className={`${isDark ? 'bg-slate-800/40' : 'bg-slate-50'} border-b ${isDark ? 'border-slate-800' : 'border-slate-100'}`}>
                  ...
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-widest text-slate-500">Description</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-widest text-slate-500">Category</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-widest text-slate-500">Date</th>
                  <th className="px-4 py-6 text-right text-[10px] font-black uppercase tracking-widest text-slate-500">Amount</th>
                  <th className="px-4 py-6 text-center text-[10px] font-black uppercase tracking-widest text-slate-500">Actions</th>
                </tr>
              </thead>
